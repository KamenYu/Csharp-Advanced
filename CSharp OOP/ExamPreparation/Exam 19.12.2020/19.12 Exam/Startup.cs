...
namespace WarCroft
{
	public class StartUp
	{
		public static void Main(string[] args)
		{
            ...
            /* Use the below configuration instead of the usual one if you wish 
             * to print all output messages together after the inputs for easier comparison with the example output. */
